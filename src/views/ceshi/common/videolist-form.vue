...
export default defineComponent({
  setup () {
    ...
    return { form, searchClick }
  }
  // data () {
  //   return {
  //     form: {},
  //     updateBeginTime: [nowdataStart, nowdataEnd],
  //     pickerOptions: {
  //       disabledDate (time) {
  ...
  // },
  // methods: {
  //   async getoilStationList () {
  //     // this.oilStationList = await this.oilStationListFn()
  //   },
  //   searchClick () {
  //     const form = util.removeEmpty(this.form)
